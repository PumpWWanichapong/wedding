...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">ข้อมูลการลองชุดเช่า</h6>
            </div>
    ...
    <div class="modal fade" id="AccountLine" aria-hidden="true"  aria-labelledby="AccountLine" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ข้อมูลสมาชิค</h5>
                </div>
                <div class="modal-body">
  ...
  function Close(){
     window.location.assign("Attempt.php")
  }
